...
if (is.na(calendar_date_col)) stop("No calendar date column found.")

calendar_raw$calendar_date <- as.Date(calendar_raw[[calendar_date_col]])
...
if (anyNA(pm_cal[needed_cal])) stop("Calendar merge produced missing values.")
